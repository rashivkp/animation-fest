...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fest_item', 'category', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Item.category'
        db.alter_column(u'fest_item', 'category', self.gf('django.db.models.fields.CharField')(max_length=8))
