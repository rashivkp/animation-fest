...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fest_student', 'std', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Student.std'
        db.alter_column(u'fest_student', 'std', self.gf('django.db.models.fields.IntegerField')(default=0))
