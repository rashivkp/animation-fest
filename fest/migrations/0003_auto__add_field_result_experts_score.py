...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.experts_score'
        db.add_column(u'fest_result', 'experts_score',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.experts_score'
        db.delete_column(u'fest_result', 'experts_score')
