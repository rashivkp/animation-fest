...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.code'
        db.alter_column(u'fest_participant', 'code', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Participant.code'
        db.alter_column(u'fest_participant', 'code', self.gf('django.db.models.fields.IntegerField')())
